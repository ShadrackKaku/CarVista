...
export const metadata: Metadata = {
  ...
  description:
    `Browse ${SITE.name}'s directory of verified car dealers across Ghana. Read reviews, view inventory and buy with confidence.`,
  ...
  return (
    <div>
      <PageHeader
        ...
        description={`Every dealer on ${SITE.name} is vetted and badged. Browse inventory, read reviews and connect directly.`}
      />
